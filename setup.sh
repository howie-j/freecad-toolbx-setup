...
toolbox run -c freecad-toolbox sh ./fedora_38_dependencies.sh || echo "freecad dependencies installation failed"
toolbox run -c freecad-toolbox sh ./compile.sh || echo "freecad dependencies installation failed"
